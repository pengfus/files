...
insert into o2o.sys_menu (menu_id, parent_id, name, url, perms, type, icon, order_num, pc_showed, app_code, app_order_num, remark, sys_belong) values (775, 554, '任务列表', 'modules/operationManage/stoTaskList.html', 'operation:tasks:get,operation:task:groups:get', 1, null, 9, 1, 'APP_MENU_OPERATION_TASK_', null, null, 'o2o');
