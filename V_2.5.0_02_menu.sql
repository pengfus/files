...
insert into o2o.sys_menu (menu_id, parent_id, name, url, perms, type, icon, order_num, pc_showed, app_code, app_order_num, remark, sys_belong) values (816, 775, '删除收集数据', null, 'operation:tasks:details:delete', 2, null, 0, 1, 'APP_MENU_OPERATION_TASK', null, null, 'o2o');
insert into o2o.sys_menu (menu_id, parent_id, name, url, perms, type, icon, order_num, pc_showed, app_code, app_order_num, remark, sys_belong) values (815, 775, '修改收集数据', null, 'operation:tasks:details:put', 2, null, 0, 1, 'APP_MENU_OPERATION_TASK', null, null, 'o2o');
insert into o2o.sys_menu (menu_id, parent_id, name, url, perms, type, icon, order_num, pc_showed, app_code, app_order_num, remark, sys_belong) values (814, 775, '提交', null, 'operation:tasks:details:post', 2, null, 0, 1, 'APP_MENU_OPERATION_TASK', null, null, 'o2o');
insert into o2o.sys_menu (menu_id, parent_id, name, url, perms, type, icon, order_num, pc_showed, app_code, app_order_num, remark, sys_belong) values (813, 775, '查看详情', null, 'operation:tasks:details:groupByCreateTime,operation:task:definitions:get,operation:tasks:details:get', 2, null, 0, 1, 'APP_MENU_OPERATION_TASK', null, null, 'o2o');
...
insert into o2o.sys_menu (menu_id, parent_id, name, url, perms, type, icon, order_num, pc_showed, app_code, app_order_num, remark, sys_belong) values (775, 554, '任务列表', 'modules/operationManage/stoTaskList.html', 'operation:tasks:get,operation:task:groups:get', 1, null, 9, 1, 'APP_MENU_OPERATION_TASK', null, null, 'o2o');
insert into o2o.sys_menu (menu_id, parent_id, name, url, perms, type, icon, order_num, pc_showed, app_code, app_order_num, remark, sys_belong) values (774, 554, '物料申请', 'modules/operationManage/stoMaterialRequisition.html', null, 1, null, 8, 1, null, null, null, 'o2o');
insert into o2o.sys_menu (menu_id, parent_id, name, url, perms, type, icon, order_num, pc_showed, app_code, app_order_num, remark, sys_belong) values (772, 554, '任务管理', 'modules/operationManage/heaTaskManage.html', 'operation:task:definitions:get,operation:task:groups:get', 1, null, 10, 1, null, null, null, 'o2o');
insert into o2o.sys_menu (menu_id, parent_id, name, url, perms, type, icon, order_num, pc_showed, app_code, app_order_num, remark, sys_belong) values (771, 554, '任务组设置', 'modules/operationManage/heaTaskGroupSettings.html', 'operation:task:groups:get', 1, null, 9, 1, null, null, null, 'o2o');
insert into o2o.sys_menu (menu_id, parent_id, name, url, perms, type, icon, order_num, pc_showed, app_code, app_order_num, remark, sys_belong) values (770, 554, '物料申请管理', 'modules/operationManage/heaMaterialApplicationManage.html', null, 1, null, 9, 1, null, null, null, 'o2o');
